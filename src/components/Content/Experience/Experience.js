...
<div >
        ...
        <div className = "main">
        <h3>Junior Web Developer (Internship) <br /> Howden Simsmart - Brossard, QC<br />05/2018 - 07/2018</h3><br/>
        ...
        User can register, log in, create custom graphs/dashboards and
                afterwards show the data on charts by retrieving from any kind of back-end.<br />
        ...
        <h5>Technologies implemented : <span>HTML5, CSS3, Materialize CSS, JS, JSON, jQuery, NPM</span><br />
        ...
        <h4>- Development of online video/movie library.  User can connect and buy movies, as well as filter by category, 
                rate etc..</h4> <br />
        <h5>Technologies implemented : <span>PHP, MySQL, Apache server, MVC, HTML5, CSS3, Bootstrap, JavaScript, JSON, jQuery</span><br />
